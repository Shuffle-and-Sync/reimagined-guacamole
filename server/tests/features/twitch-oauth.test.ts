...
describe('Twitch OAuth Security Features', () => {
  ...
  describe('Redirect URI Validation', () => {
    test('should construct correct redirect URI for development', () => {
      ...
      expect(redirectUri).toBe('http://localhost:3000/api/platforms/twitch/oauth/callback');
    });
    ...
    test('should construct correct redirect URI for production', () => {
      ...
      expect(redirectUri).toBe('https://shuffleandsync.com/api/platforms/twitch/oauth/callback');
    });
  ...
  describe('OAuth URL Generation', () => {
    test('should include all required OAuth parameters', () => {
      const params = {
        ...
        redirect_uri: 'http://localhost:3000/api/platforms/twitch/oauth/callback',
        response_type: 'code',
