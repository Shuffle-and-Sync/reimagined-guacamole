...
describe('Admin Account Initialization', () => {
  ...
  describe('Admin Verification', () => {
    ...
    it('should identify missing configuration', () => {
      ...
      expect(issues).toContain('MASTER_ADMIN_EMAIL environment variable is not set');
    });
    ...
    it('should provide actionable recommendations', () => {
      ...
      expect(recommendation).toBe('Run npm run admin:init to resolve configuration issues');
    });
  });
  ...
  describe('Production Deployment', () => {
    ...
    it('should recommend OAuth for production admin access', () => {
      ...
      const recommendation = hasOAuth && !hasPassword
        ? 'Using OAuth-only authentication (recommended for security)'
        : 'Using credentials authentication';

      expect(recommendation).toBe('Using OAuth-only authentication (recommended for security)');
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle missing environment gracefully', () => {
      ...
      if (!config.email) {
        ...
        expect(error).toBe('MASTER_ADMIN_EMAIL not set in environment variables');
      }
    });
  ...
  describe('POST /api/admin/system/verify-admin', () => {
    ...
    it('should identify configuration issues', () => {
      const mockResponse = {
        ...
        recommendation: 'Run npm run admin:init to resolve configuration issues',
        securityRecommendations: []
      };
