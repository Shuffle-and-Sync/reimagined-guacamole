...
describe("Security Utilities", () => {
  ...
  describe("isSecureToken", () => {
    ...
    test("should reject tokens with weak patterns", () => {
      ...
      expect(isSecureToken("1234567890123456789012345678901234567890")).toBe(
        false,
      );
  ...
  describe("detectCredentialLeak", () => {
    test("should detect various credential patterns", () => {
      expect(
        detectCredentialLeak("sk_live_1234567890abcdef1234567890abcdef"),
      ).toBe(true);
      expect(
        detectCredentialLeak("AIzaSyD4iO1234567890abcdef1234567890abc"),
      ).toBe(true);
      expect(
        detectCredentialLeak("ghp_1234567890abcdef1234567890abcdef123456"),
      ).toBe(true);
      expect(
        detectCredentialLeak(
