...
describe('PokemonTCGAdapter', () => {
  ...
  describe('searchCards', () => {
    ...
    it('should handle empty results', async () => {
      ...
      await expect(pokemonTCGAdapter.searchCards('NonexistentCard')).rejects.toThrow();
    });
  });
        ...
        card_images: [
          {
            ...
            image_url_small: 'https://images.ygoprodeck.com/images/cards_small/12345.jpg',
            image_url_cropped: 'https://images.ygoprodeck.com/images/cards_cropped/12345.jpg',
          },
        ],
      };
