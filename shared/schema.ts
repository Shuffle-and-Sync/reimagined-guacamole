...
export const moderationQueue = pgTable("moderation_queue", {
  ...
  mlPriority: integer("ml_priority"), // ML-generated priority score
  autoGenerated: boolean("auto_generated").default(false), // Whether this was auto-generated
  ...
  metadata: jsonb("metadata"), // Additional metadata for the queue item
  
  // Resolution tracking
  resolution: text("resolution"), // Resolution notes when completed
  actionTaken: text("action_taken"), // Action taken to resolve the item
...
export const userAppeals = pgTable("user_appeals", {
  ...
  resolvedAt: timestamp("resolved_at"), // When the appeal was resolved
...
export const insertModerationActionSchema = createInsertSchema(moderationActions, {
  action: z.enum(["warn", "mute", "restrict", "shadowban", "ban", "unban", "content_remove", "account_suspend", "note", "unmute"]),
...
export const insertModerationQueueSchema = createInsertSchema(moderationQueue, {
  ...
  riskScore: z.coerce.number().min(0).max(1).optional(),
  mlPriority: z.number().int().optional(),
...
export const insertUserAppealSchema = createInsertSchema(userAppeals, {
  evidence: z.any().optional(),
  status: z.enum(["pending", "under_review", "approved", "denied", "withdrawn", "resolved"]).optional(),
