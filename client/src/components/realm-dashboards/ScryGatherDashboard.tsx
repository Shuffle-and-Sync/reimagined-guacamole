        ...
        <div className="container mx-auto px-4 py-12 relative">
          <div className="text-center space-y-6">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full" 
                 style={{ backgroundColor: theme.colors.primary + '20', border: `2px solid ${theme.colors.primary}` }}>
              <i className="fas fa-magic text-2xl" style={{ color: theme.colors.primary }}></i>
              <span className="text-2xl font-bold" style={{ fontFamily: theme.fonts.heading, color: theme.colors.primary }}>
                Scry & Gather
              </span>
            </div>
            
            <div className="flex items-center justify-center gap-4">
              <Avatar className="h-20 w-20 border-4" style={{ borderColor: theme.colors.primary }}>
              ...
              <div className="text-left">
                <h1 className="text-4xl font-bold mb-2" style={{ fontFamily: theme.fonts.heading, color: theme.colors.text }}>
                  Welcome, {user.firstName || 'Planeswalker'}
                </h1>
                <p className="text-lg" style={{ fontFamily: theme.fonts.body, color: theme.colors.textSecondary }}>
      ...
      <div className="container mx-auto px-4 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 -mt-6">
          <Link href="/matchmaking">
            <Card className="group hover:scale-105 transition-all duration-300 cursor-pointer border-2"
                  style={{ borderColor: theme.colors.primary, background: theme.gradients.card }}>
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center relative"
                     style={{ background: 'linear-gradient(135deg, #ff4444 0%, #ff8844 100%)' }}>
                  <i className="fas fa-fire text-white text-xl"></i>
                  <div className="absolute -top-1 -right-1 w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center">
                    <span className="text-white text-xs font-bold">R</span>
                  </div>
                </div>
                <h3 className="font-bold mb-2" style={{ fontFamily: theme.fonts.heading, color: theme.colors.text }}>
          ...
          <Link href="/tablesync">
            <Card className="group hover:scale-105 transition-all duration-300 cursor-pointer border-2"
                  style={{ borderColor: theme.colors.accent, background: theme.gradients.card }}>
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center relative"
                     style={{ background: 'linear-gradient(135deg, #4444ff 0%, #8844ff 100%)' }}>
          ...
          <Card className="group hover:scale-105 transition-all duration-300 cursor-pointer border-2"
            ...
            <CardContent className="p-6 text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center relative"
                   style={{ background: 'linear-gradient(135deg, #44ff44 0%, #88ff44 100%)' }}>
          ...
          <Card className="group hover:scale-105 transition-all duration-300 cursor-pointer border-2"
            ...
            <CardContent className="p-6 text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center relative"
                   style={{ background: 'linear-gradient(135deg, #ffff44 0%, #ffaa44 100%)' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="lg:col-span-2 border-2" style={{ borderColor: theme.colors.primary, background: theme.gradients.card }}>
            <CardHeader>
              <CardTitle className="flex items-center gap-3" style={{ fontFamily: theme.fonts.heading, color: theme.colors.text }}>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 rounded-lg" style={{ backgroundColor: theme.colors.surface }}>
                  ...
                  <div className="flex-1">
                    <p className="font-medium" style={{ color: theme.colors.text }}>
                      Welcome to the Multiverse, {user.firstName || 'Planeswalker'}!
                    </p>
                    <p className="text-sm" style={{ color: theme.colors.textSecondary }}>
                      Your spark has ignited and you've joined the ranks of planeswalkers
                    </p>
                  </div>
                  <Badge variant="outline" style={{ borderColor: theme.colors.primary, color: theme.colors.primary }}>
                    Just now
                  </Badge>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-lg" style={{ backgroundColor: theme.colors.surface }}>
                  ...
                  <Badge variant="outline" style={{ borderColor: theme.colors.accent, color: theme.colors.accent }}>
                    2h ago
                  </Badge>
                </div>
              </div>
          ...
          <Card className="border-2" style={{ borderColor: theme.colors.accent, background: theme.gradients.card }}>
            <CardHeader>
              <CardTitle className="flex items-center gap-3" style={{ fontFamily: theme.fonts.heading, color: theme.colors.text }}>
                <div className="w-10 h-10 rounded-full flex items-center justify-center"
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 rounded-lg border" style={{ borderColor: theme.colors.primary, backgroundColor: theme.colors.surface }}>
                  <div className="flex items-center gap-3 mb-3">
                    <i className="fas fa-magic text-lg" style={{ color: theme.colors.primary }}></i>
                  ...
                  <div className="space-y-2 text-sm" style={{ color: theme.colors.textSecondary }}>
                    <div className="flex justify-between">
                      ...
                      <Badge style={{ backgroundColor: theme.colors.primary, color: theme.colors.text }}>
                        Initiate
                      </Badge>
                    </div>
                    <div className="flex justify-between">
