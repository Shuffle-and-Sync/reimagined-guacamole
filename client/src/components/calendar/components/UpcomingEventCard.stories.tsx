...
export const AsEventCreator: Story = {
  args: {
    event: {
      ...
      endTime: new Date("2024-12-20T23:00:00"),
      type: "tournament",
      status: "active",
...
export const UserAttending: Story = {
  args: {
    event: {
      ...
      endTime: new Date("2024-12-21T22:00:00"),
      type: "community",
      status: "active",
      timezone: "America/New_York",
      displayTimezone: null,
...
export const LargeEvent: Story = {
  args: {
    event: {
      ...
      endTime: new Date("2024-12-28T20:00:00"),
      type: "tournament",
      status: "active",
      timezone: "America/New_York",
      displayTimezone: null,
...
export const WithWaitlist: Story = {
  args: {
    event: {
      ...
      hostId: "user-5",
      communityId: "elite-1",
      startTime: new Date("2024-12-25T16:00:00"),
      endTime: new Date("2024-12-25T20:00:00"),
      type: "game_pod",
      status: "active",
      timezone: "America/New_York",
      displayTimezone: null,
