        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center items-center mb-8">
              <div className="relative w-64 h-64">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    className="w-56 h-56 border-2 border-gradient-to-r from-yellow-400 to-orange-400 rounded-full opacity-15 animate-spin"
                ...
                <div className="absolute bottom-8 right-8">
                  <div
                    className="w-4 h-4 bg-cyan-400 rounded-full animate-float opacity-60 flex items-center justify-center text-white text-xs"
                    style={{ animationDelay: "1s" }}
                  >
                    ⚔️
                  </div>
                ...
                <div className="absolute top-12 left-8">
                  <div
                    className="w-3 h-3 bg-pink-400 clip-path-diamond animate-float opacity-70 flex items-center justify-center text-white text-xs"
                    style={{ animationDelay: "2s" }}
                  >
                    ✨
                  </div>
                ...
                <div className="absolute bottom-12 left-12">
                  <div
                    className="w-5 h-5 bg-purple-400 rounded-full animate-float opacity-50 flex items-center justify-center text-white text-xs"
                    style={{ animationDelay: "1.5s" }}
                  >
                    👑
                  </div>
            ...
            <p className="text-xl lg:text-2xl text-purple-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Join the arena! Sign in to register for competitive tournaments,
              track your progress, and compete for glory across all major TCG
              platforms.
            </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-purple-200 max-w-3xl mx-auto">
              Everything you need to dominate the competitive TCG scene and
              climb the rankings.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <Card className="group hover:border-primary transition-all duration-300 h-full bg-card/50 backdrop-blur-sm border-border/50">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Join structured tournaments with real-time bracket tracking,
                  seeding systems, and prize pool distribution for serious
                  competition.
                </p>
            ...
            <Card className="group hover:border-secondary transition-all duration-300 h-full bg-card/50 backdrop-blur-sm border-border/50">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Build your reputation with competitive ratings, match history,
                  and performance analytics across different game formats.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
            ...
            <Card className="group hover:border-accent transition-all duration-300 h-full bg-card/50 backdrop-blur-sm border-border/50">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Earn achievements, unlock titles, and showcase your tournament
                  victories with detailed winner profiles and trophy
                  collections.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
              ...
              <CardContent className="p-8">
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-lg border border-yellow-500/30">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Magic: The Gathering • Round 3 of 5 • $500 Prize Pool
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg border border-blue-500/30">
                    <div>
                      <h3 className="font-semibold text-foreground">
                        Pokemon Regional Qualifier
                      </h3>
                      <p className="text-sm text-muted-foreground">
                        Registration Open • Swiss Format • 64 Players
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg border border-purple-500/30">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your Rating: 1,847 • Rank: Gold III
                      </p>
                    </div>
