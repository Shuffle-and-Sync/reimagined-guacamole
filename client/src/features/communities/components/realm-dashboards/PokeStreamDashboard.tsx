...
export function PokeStreamDashboard({ user }: PokeStreamDashboardProps) {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #ffd700 0%, #4a90e2 50%, #ffd700 100%)' }}>
          ...
          <div className="text-center space-y-6">
            ...
            <div className="flex items-center justify-center gap-6">
              ...
              <div className="text-left">
                <h1 className="text-5xl font-bold mb-2 text-white text-shadow-lg" 
                    style={{ fontFamily: theme.fonts.heading, textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>
                  Hey {user.firstName || 'Trainer'}!
                </h1>
                <p className="text-xl text-white/90 mb-3" style={{ fontFamily: theme.fonts.body }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 -mt-8">
          <Link href="/matchmaking">
            <Card className="group hover:scale-105 hover:rotate-1 transition-all duration-300 cursor-pointer bg-white border-4 border-red-400 shadow-xl">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold mb-2 text-xl text-red-600" style={{ fontFamily: theme.fonts.heading }}>
                  {theme.terminology.quickMatch}
                </h3>
                <p className="text-sm text-gray-600" style={{ fontFamily: theme.fonts.body }}>
          ...
          <Link href="/tablesync">
            <Card className="group hover:scale-105 hover:rotate-1 transition-all duration-300 cursor-pointer bg-white border-4 border-blue-400 shadow-xl">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-bold mb-2 text-xl text-blue-600" style={{ fontFamily: theme.fonts.heading }}>
          ...
          <Card className="group hover:scale-105 hover:rotate-1 transition-all duration-300 cursor-pointer bg-white border-4 border-green-400 shadow-xl">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-bold mb-2 text-xl text-green-600" style={{ fontFamily: theme.fonts.heading }}>
          ...
          <Card className="group hover:scale-105 hover:rotate-1 transition-all duration-300 cursor-pointer bg-white border-4 border-purple-400 shadow-xl">
            <CardContent className="p-6 text-center">
              ...
              <h3 className="font-bold mb-2 text-xl text-purple-600" style={{ fontFamily: theme.fonts.heading }}>
                Pokemon Center
              </h3>
              <p className="text-sm text-gray-600" style={{ fontFamily: theme.fonts.body }}>
                Meet other trainers
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border-2 border-blue-200">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-lg text-blue-800" style={{ fontFamily: theme.fonts.heading }}>
                      Welcome to Pokemon World, {user.firstName || 'Trainer'}!
                    </p>
                    <p className="text-blue-600" style={{ fontFamily: theme.fonts.body }}>
                      Your Pokedex has been activated and you're ready to catch 'em all!
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-yellow-50 rounded-2xl border-2 border-green-200">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-lg text-green-800" style={{ fontFamily: theme.fonts.heading }}>
                      Gym Challenge Available!
                    </p>
                    <p className="text-green-600" style={{ fontFamily: theme.fonts.body }}>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gradient-to-r from-red-50 to-yellow-50 rounded-xl border-2 border-red-200">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="font-bold text-lg text-red-600" style={{ fontFamily: theme.fonts.heading }}>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-1">
                        {[1,2,3,4,5,6,7,8].map((badge) => (
                          <div key={badge} className={`w-6 h-6 rounded-full ${badge <= 6 ? 'bg-gradient-to-r from-yellow-400 to-orange-400' : 'bg-gray-300'} flex items-center justify-center`}>
                            <i className={`fas fa-medal text-white text-xs ${badge > 6 ? 'text-gray-500' : ''}`}></i>
                          </div>
                        ))}
                      </div>
                    </div>
