        ...
        <div className="container mx-auto px-4 py-12 relative">
          <div className="text-center space-y-6">
            <div className="inline-flex items-center gap-4 px-8 py-4 rounded-2xl bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm border border-slate-200 dark:border-slate-800 shadow-lg">
              ...
              <span className="text-3xl font-bold bg-gradient-to-r from-slate-700 to-indigo-600 bg-clip-text text-transparent" 
            ...
            <div className="flex items-center justify-center gap-6">
              ...
              <div className="text-left">
                <h1 className="text-4xl font-bold mb-2 text-slate-800 dark:text-slate-200" 
                    style={{ fontFamily: theme.fonts.heading }}>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Link href="/matchmaking">
            <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800" data-testid="card-quick-match">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2 text-lg text-slate-700 dark:text-slate-300" style={{ fontFamily: theme.fonts.heading }}>
                  {theme.terminology.quickMatch}
                </h3>
                <p className="text-sm text-slate-600 dark:text-slate-400" style={{ fontFamily: theme.fonts.body }}>
          ...
          <Link href="/tablesync">
            <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800" data-testid="card-tablesync">
              <CardContent className="p-6 text-center">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800" data-testid="card-events">
            <CardContent className="p-6 text-center">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 cursor-pointer bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800" data-testid="card-analysis">
            <CardContent className="p-6 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Recent Activity */}
          <Card className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800" data-testid="card-activity">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-slate-800 dark:text-slate-200" style={{ fontFamily: theme.fonts.heading }}>
                      Welcome to Deckmaster, {user.firstName || 'Strategist'}!
                    </p>
                    <p className="text-sm text-slate-600 dark:text-slate-400" style={{ fontFamily: theme.fonts.body }}>
                      Your strategic command center is ready. Master the meta together.
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-4 p-4 bg-indigo-50 dark:bg-indigo-950 rounded-lg border border-indigo-200 dark:border-indigo-800">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-indigo-800 dark:text-indigo-200" style={{ fontFamily: theme.fonts.heading }}>
                      Meta Analysis Available
                    </p>
                    <p className="text-sm text-indigo-600 dark:text-indigo-400" style={{ fontFamily: theme.fonts.body }}>
                      New competitive insights on optimal deck construction strategies
                    </p>
                  </div>
                  <Badge variant="outline" className="text-xs text-indigo-600 border-indigo-600">
                    4h ago
                  </Badge>
                </div>
              </div>
          ...
          {/* Strategic Profile */}
          <Card className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800" data-testid="card-profile">
            <CardHeader className="bg-gradient-to-r from-indigo-600 to-slate-600 text-white">
              <CardTitle className="flex items-center gap-3" style={{ fontFamily: theme.fonts.heading }}>
                <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                  <i className="fas fa-user text-white text-sm"></i>
                </div>
                Strategic Profile
              </CardTitle>
              <CardDescription className="text-white/90 text-sm" style={{ fontFamily: theme.fonts.body }}>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-slate-800 dark:text-slate-200" style={{ fontFamily: theme.fonts.heading }}>
                      Current Focus: Deckmaster
                    </span>
                  </div>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between items-center">
                      <span className="text-slate-600 dark:text-slate-400">Strategic Rank:</span>
                      <Badge className="bg-gradient-to-r from-slate-600 to-indigo-600 text-white text-xs px-2 py-1">
                        Master
                      </Badge>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-600 dark:text-slate-400">Focus Areas:</span>
                      <div className="flex gap-1">
                        <Badge variant="outline" className="text-xs text-slate-600 border-slate-600">Meta</Badge>
                        <Badge variant="outline" className="text-xs text-indigo-600 border-indigo-600">Theory</Badge>
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-600 dark:text-slate-400">Sessions Led:</span>
                      <span className="font-semibold text-slate-800 dark:text-slate-200">42</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-slate-600 dark:text-slate-400">Strategic Rating:</span>
                      <span className="font-semibold text-slate-800 dark:text-slate-200">1,347</span>
                    </div>
                  </div>
                </div>
