...
export const CommunityCard = memo<CommunityCardProps>(
  ...
  // Custom comparison function - only re-render if community data changes
  (prevProps, nextProps) => {
    return (
      prevProps.community.id === nextProps.community.id &&
      prevProps.community.displayName === nextProps.community.displayName &&
      prevProps.community.description === nextProps.community.description &&
      prevProps.community.iconClass === nextProps.community.iconClass
    );
  },
);
