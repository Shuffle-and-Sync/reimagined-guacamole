...
export default function Calendar() {
  ...
  const todaysEvents = events.filter(event => event.date && event.date === todayDate);
  const upcomingEvents = events.filter(event => event.date && event.date > todayDate).slice(0, 5);
