          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-6 text-muted-foreground">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">1. Expected Behavior</h3>
                <p>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">2. Unacceptable Behavior</h3>
                <p>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>Personal insults, particularly those using discriminatory terms</li>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">3. Gaming Community Guidelines</h3>
                <p>
                  Since Shuffle & Sync is a gaming platform, we have additional guidelines specific to gaming interactions:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong>Fair Play:</strong> No cheating, exploiting, or using unauthorized third-party software</li>
                  <li><strong>Good Sportsmanship:</strong> Treat opponents and teammates with respect, win or lose</li>
                  <li><strong>Constructive Communication:</strong> Offer helpful feedback rather than destructive criticism</li>
                  <li><strong>Inclusive Gaming:</strong> Welcome new players and help them learn</li>
                  <li><strong>Respect Boundaries:</strong> Don't pressure others to play beyond their comfort level</li>
                </ul>
              </div>

              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">4. Consequences of Unacceptable Behavior</h3>
                <p>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">5. Reporting Guidelines</h3>
                <p>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">6. Addressing Grievances</h3>
                <p>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground">7. Scope</h3>
                <p>
