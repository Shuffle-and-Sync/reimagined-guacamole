...
export default function Home() {
  ...
  const handleStartStreaming = useCallback(() => {
    ...
    if (selectedCommunity) {
      ...
      toast({
        ...
        description:
          "Choose a gaming community to start your streaming session.",
        variant: "default",
      });
    }
  ...
  const handleAllRealmsClick = useCallback(() => {
    ...
    toast({
      ...
      description:
        "Switch between communities using the realm selector in the header.",
    });
  }, [setLocation, toast]);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Link href="/matchmaking">
            <Card
              className="group hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer bg-gradient-to-br from-white to-blue-50 dark:from-slate-900 dark:to-blue-950 border-2 border-blue-200 dark:border-blue-800 relative overflow-hidden"
              data-testid="card-matchmaking"
            >
              ...
              <CardContent className="p-6 text-center relative">
                ...
                <h3
                  className="font-bold mb-2 text-xl text-blue-700 dark:text-blue-300"
                  style={{ fontFamily: communityTheme.fonts.heading }}
                >
                  Quick Match ⚡
                </h3>
          ...
          <Link href="/tablesync">
            <Card
              className="group hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer bg-gradient-to-br from-white to-purple-50 dark:from-slate-900 dark:to-purple-950 border-2 border-purple-200 dark:border-purple-800 relative overflow-hidden"
            ...
            >
              ...
              <CardContent className="p-6 text-center relative">
                ...
                <h3
                  className="font-bold mb-2 text-xl text-purple-700 dark:text-purple-300"
                  style={{ fontFamily: communityTheme.fonts.heading }}
                >
                  TableSync 🎮
                </h3>
          ...
          >
            ...
            <CardContent className="p-6 text-center relative">
              ...
              <h3
                className="font-bold mb-2 text-xl text-indigo-700 dark:text-indigo-300"
                style={{ fontFamily: communityTheme.fonts.heading }}
              >
                Events 🎉
              </h3>
          ...
          >
            ...
            <CardContent className="p-6 text-center relative">
              ...
              <h3
                className="font-bold mb-2 text-xl text-cyan-700 dark:text-cyan-300"
                style={{ fontFamily: communityTheme.fonts.heading }}
              >
                All Realms 🌟
              </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Activity Feed */}
          <Card
            className="lg:col-span-2 bg-white dark:bg-slate-900 border border-blue-200 dark:border-blue-800"
                ...
                <div className="flex items-center gap-4 p-4 bg-purple-50 dark:bg-purple-950 rounded-lg border border-purple-200 dark:border-purple-800">
                  ...
                  <div className="flex-1">
                    ...
                    <p
                      ...
                      style={{ fontFamily: communityTheme.fonts.body }}
                    >
                      Connect with streamers across all realms and start
                      collaborating
                    </p>
                  </div>
                  <Badge
