      ...
      if (response.ok) {
        ...
        if (data.backupCodes) {
          toast({
            ...
            description: "Download and store these codes safely - they won't be shown again.",
          });
        }
      } else {
        const errorData = await response.json();
                ...
                {showMfaSetup && (
                  <div className="border rounded-lg p-4 space-y-4">
                    ...
                    <ol className="text-sm space-y-2 text-muted-foreground">
                      ...
                      <li>2. Scan the QR code below or enter the secret manually</li>
                    ...
                    {mfaQrCode && (
                      <div className="text-center space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Manual entry code: <code className="font-mono bg-muted px-2 py-1 rounded">{mfaSecret}</code>
                        </p>
                      </div>
                    )}
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button 
                        ...
                        disabled={isMfaLoading || mfaVerificationCode.length !== 6}
