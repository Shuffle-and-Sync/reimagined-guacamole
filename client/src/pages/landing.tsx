            ...
            <div className="flex justify-center items-center mb-8">
              <div className="relative w-80 h-80">
                ...
                <div className="absolute bottom-8 right-8">
                  <div
                    className="w-4 h-4 bg-cyan-400 rounded-full animate-float opacity-60"
                    style={{ animationDelay: "1s" }}
                  ></div>
                </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4 cartoon-text">
              Choose Your Gaming Community
            </h2>
            <p className="text-xl text-purple-200 max-w-3xl mx-auto">
              Each community features specialized streaming tools, unique
              themes, and dedicated coordination features tailored for your
              favorite TCG.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Everything you need to coordinate, stream, and grow your TCG
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <Card className="group hover:border-primary transition-all duration-300 h-full">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Our advanced AI analyzes your deck power level, play style,
                  and streaming goals to match you with perfect collaboration
            ...
            <Card className="group hover:border-secondary transition-all duration-300 h-full">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Professional-grade streaming suite with multi-camera support,
                  card recognition, and seamless integration with your streaming
                  setup.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
            ...
            <Card className="group hover:border-accent transition-all duration-300 h-full">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Manage all your social media platforms from one dashboard.
                  Schedule posts, track engagement, and grow your TCG community
                  across all networks.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
            ...
            <Card className="group hover:border-green-500 transition-all duration-300 h-full">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Coordinate tournaments, collaborations, and community events
                  with intelligent scheduling that considers timezones and
                  availability.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              ...
              dashboard. Post, schedule, and analyze across all major platforms.
            </p>
          </div>
