...
console.log('');
console.log('   Example:');
console.log('   TEST_URL=http://localhost:3000 CONCURRENT_USERS=100 npm run test:load');
console.log('');
...
console.log('');
console.log('   Example:');
console.log('   TEST_URL=http://localhost:3000 MAX_USERS=300 npm run test:stress');
console.log('');
